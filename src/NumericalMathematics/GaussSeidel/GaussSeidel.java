...
public abstract class GaussSeidel
{
    ...
    public static void main(String[] args) {
        ...
        ls = new double[4][4];
        ls[0] = new double[]{10,-1,2,0};
        ls[1] = new double[]{-1,11,-1,3};
        ls[2] = new double[]{2,-1,10,-1};
        ls[3] = new double[]{0,3,-1,8};

        res = new double[]{6,25,-11,15};
        sol =  GaussSeidel.gaussseidel(ls,res,100,new double[]{0,0,0,0});
